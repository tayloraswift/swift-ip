...
extension IP {
    @frozen public struct Claims: Identifiable, Sendable {
        public let id: IP.Claimant

        public var v4: [ClosedRange<IP.V4>]
        public var v6: [ClosedRange<IP.V6>]
...
extension IP.Claims {
    mutating func extend(with blocks: [IP.AnyCIDR]) {
