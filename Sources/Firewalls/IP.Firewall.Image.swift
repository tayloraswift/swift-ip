...
extension IP.Firewall {
    ...
    @frozen public struct Image: Sendable {
        @usableFromInline var autonomousSystems: [IP.AS]
        @usableFromInline var asn: IP.Table<IP.ASN>
        @usableFromInline var country: IP.Table<ISO.Country>
        @usableFromInline var claimant: IP.Table<Int32>
        @usableFromInline var claimants: [IP.Claimant]

        @inlinable public init(autonomousSystems: [IP.AS] = []) {
...
extension IP.Firewall.Image {
    public mutating func colorByASN(
        v4: [(IP.ASN, ip: ClosedRange<IP.V4>)],
        v6: [(IP.ASN, ip: ClosedRange<IP.V6>)]
    ) throws {
    ...
    public mutating func colorByCountry(
        v4: [(ISO.Country, ip: ClosedRange<IP.V4>)],
        v6: [(ISO.Country, ip: ClosedRange<IP.V6>)]
    ) throws {
        var v4Ranges: BSON.BinaryArray<ClosedRange<IP.V4>> = .init(count: v4.count)
    ...
    public mutating func colorByClaimant(
