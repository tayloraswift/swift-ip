...
extension IP {
    ...
    @frozen public struct Table<Color> where Color: BSON.BinaryPackable {
        @usableFromInline var v4: SortedArray<V4>
        @usableFromInline var v6: SortedArray<V6>
...
extension IP.Table {
    ...
    @inlinable public subscript(v4 ip: IP.V4) -> Color? {
    ...
    @inlinable public subscript(v6 ip: IP.V6) -> Color? {
