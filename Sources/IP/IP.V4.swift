extension IP {
    ...
    @frozen public struct V4: Address, ExpressibleByIntegerLiteral {
...
extension IP.V4 {
    ...
    /// loopback range.
    @inlinable public static var localhost: Self { .init(value: 0x7F_00_00_01) }
}
...
extension IP.V4: LosslessStringConvertible {
    ...
    @inlinable public init?(_ description: some StringProtocol) {
        ...
        let a: UInt8 = .init(description[..<b]) else {
            return nil
        }
        ...
        let b: UInt8 = .init(description[b ..< c]) else {
            return nil
        }
        ...
        let c: UInt8 = .init(description[c ..< d]) else {
            return nil
        }
        ...
        guard
        let d: UInt8 = .init(description[d...]) else {
            return nil
        }
